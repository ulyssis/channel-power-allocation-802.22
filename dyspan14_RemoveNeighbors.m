function  [availableChannelsAllWBSs] = dyspan14_RemoveNeighbors(n, c, Cmax, channelAllocation, availableChannelsAllWBSs, P_CVX, Gtilde, TVpower, delta, eta)
...
for elm = WbsIndiceHavingTheChannel
    ...
    tem = D1;
    tem(elm) =1;
   TT1 = dyspan14_TotalThroughtput(Cmax, tem, n, c, P_CVX, Gtilde, TVpower, delta, eta);
   TT2 = dyspan14_TotalThroughtput(Cmax, D1, n, c, P_CVX, Gtilde, TVpower, delta, eta);
