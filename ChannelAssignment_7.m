...
%%%% run channel assignment schemes
        [utilityHistory, powerHistory, averageSinrHistory, averageStdHistory, SINR_ETs_random_container, SINR_ETs_whitecat_container, SINR_ETs_whitecase_container, ...
            ...
            B_random, B_cat, B_case, B_lindo, B_noregret, B_PotentialGame, B_lindoCAPA, flag_resolve] ...%snrRatio_random, snrRatio_dica, snrRatio_self, snrRatio_noregret]... % to help function printplots4schemes
